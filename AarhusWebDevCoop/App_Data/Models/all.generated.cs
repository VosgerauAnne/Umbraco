...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "9cf3729d9a2fb515")]
...
#pragma warning restore 0109
		...
		/// Projects Body
		///</summary>
		[ImplementPropertyType("projectsBody")]
		public IHtmlString ProjectsBody
		{
			get { return this.GetPropertyValue<IHtmlString>("projectsBody"); }
		}
...
#pragma warning restore 0109
	...
	/// <summary>Kompetencer</summary>
	[PublishedContentModel("kompetencer")]
	public partial class Kompetencer : Master
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "kompetencer";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public Kompetencer(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<Kompetencer, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
		...
		/// Skill Description
		///</summary>
		[ImplementPropertyType("skillDescription")]
		public IHtmlString SkillDescription
		{
			get { return this.GetPropertyValue<IHtmlString>("skillDescription"); }
		}
		...
		{
			get { return this.GetPropertyValue<string>("skillTitle"); }
		}
	}
